...
const result = await build({
  ...
  outfile: "dist/contrast-checker.js",
  bundle: true,
  format: "iife",
  target: "es2020",
  platform: "browser",
...
await build({
  ...
  outfile: "dist/contrast-checker.css",
  bundle: true,
  minify: false,
  banner: { css: banner },
});

const out = result.metafile.outputs["dist/contrast-checker.js"];
const css = await readFile(new URL("../dist/contrast-checker.css", import.meta.url));
...
await writeFile(
  ...
  [
    ...
    "element with a data-cc attribute.",
    "",
  ].join("\n"),
);
